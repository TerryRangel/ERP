...
export default function Navbar({ onMenuClick, isMobile }) {
  ...
  const [showSearchBar, setShowSearchBar] = useState(false); // móvil: toggle del buscador
    ...
    <header style={{
      ...
      <div style={{ display: "flex", alignItems: "center", gap: isMobile ? "12px" : "28px", minWidth: 0 }}>
        ...
        >
          ...
          {/* En móvil pequeño ocultamos el texto para no saturar */}
          {!isMobile && (
            <div>
        ...
        {/* Buscador — oculto en móvil hasta que se active */}
        {!isMobile && (
      ...
      <div style={{ display: "flex", alignItems: "center", gap: isMobile ? "8px" : "20px", flexShrink: 0 }}>
        ...
        {isMobile && (
          <div ref={searchRef} style={{ position: "relative" }}>
            ...
            {/* Buscador expandido debajo del header en móvil */}
            {showSearchBar && (
              <div style={{
                position: "fixed",
                top: "74px",
        ...
        {/* AJUSTES — se oculta en móvil para ahorrar espacio */}
        {!isMobile && (
          <button
