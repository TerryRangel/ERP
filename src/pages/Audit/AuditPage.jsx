  ...
  const filteredLogs = logs.filter((log) => {
    ...
    const matchSearch = search
      ? (log.usuario || '').toLowerCase().includes(q) ||
        (log.details?.mensaje || log.details?.nombre || '')
          .toLowerCase()
          .includes(q) ||
          ...
          <div className="flex flex-col lg:flex-row gap-4 w-full xl:w-auto">
            ...
            <div className="relative">
              <input
                ...
                className="
                  w-full lg:w-[360px] h-[58px]
                  rounded-2xl border border-[#E5EBDD]
                  bg-white pl-5 pr-14
                  text-sm font-medium text-gray-700
                  outline-none transition-all shadow-sm
                  focus:border-[#7E8B63]
                  focus:ring-4 focus:ring-[#7E8B63]/10
                "
              />
            ...
            <div className="relative">
              <button
                ...
                className="
                  h-[58px] px-6 rounded-2xl bg-white
                  border border-[#E5EBDD] text-gray-700
                  font-semibold flex items-center gap-3
                  shadow-sm hover:border-[#7E8B63] hover:bg-[#FAFBF8]
                  transition-all
                "
              >
                  ...
                  <div className="space-y-5">
                    <div>
                      ...
                      <select
                        ...
                        className="w-full rounded-2xl border border-[#E5EBDD] bg-[#EEF2E7] px-4 py-3 text-sm font-medium text-gray-700 outline-none"
                      >
            ...
            <button
              ...
              className={`
                h-[58px] px-6 rounded-2xl bg-[#1F2937] text-white
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-xs text-gray-400 mt-1">
                              ID: {(log.id || log._id || '').toString().slice(0, 8)}
                            </p>
                          </div>
                        </div>
                      </td>
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1 uppercase tracking-wider font-bold">
                    ID: {selectedLog.id || selectedLog._id}
                  </p>
                </div>
              </div>
              <button 
                ...
                <div className="grid grid-cols-2 gap-6 bg-[#F4F6F0] p-6 rounded-3xl border border-[#E5EBDD]">
                  ...
                  <div>
                    ...
                    <span className="block text-base font-bold text-gray-800 flex items-center gap-2">
                      ...
                      {formatDate(selectedLog.createdAt || selectedLog.fecha)}
                    </span>
                  </div>
                  <div>
